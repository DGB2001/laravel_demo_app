...
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <h3 class="title"><a href="post-details.html">How to write a title with an optimal width for--}}
{{--                                    SEO</a></h3>--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">Learn What Marketing Is and How It Is Used</a>--}}
{{--                        </h4>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <!-- End Single Post  -->--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">How to use your keyphrase in the SEO title</a>--}}
{{--                        </h4>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <!-- End Single Post  -->--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">Facebook for Business: Marketing on Facebook</a>--}}
{{--                        </h4>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <!-- End Single Post  -->--}}
...
{{--                    <h2 class="title">What's new at Bloger</h2>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--        <div class="row">--}}
...
{{--                        <a class="nav-link active" id="tab-one" data-bs-toggle="tab" href="#tabone" role="tab"--}}
{{--                           aria-controls="tab-one" aria-selected="true">Search Engines</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" role="presentation">--}}
{{--                        <a class="nav-link" id="tab-two" data-bs-toggle="tab" href="#tabtwo" role="tab"--}}
{{--                           aria-controls="tab-two" aria-selected="false">Research</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" role="presentation">--}}
{{--                        <a class="nav-link" id="tab-three" data-bs-toggle="tab" href="#tabthree" role="tab"--}}
{{--                           aria-controls="tab-three" aria-selected="false">Marketing</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" role="presentation">--}}
{{--                        <a class="nav-link" id="tab-four" data-bs-toggle="tab" href="#tabfour" role="tab"--}}
{{--                           aria-controls="tab-four" aria-selected="false">Branding</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--                <!-- End Tab Button  -->--}}
...
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <h4 class="title"><a href="post-details.html">Introducing Keyword Data in Site--}}
{{--                                                Explorer</a></h4>--}}
{{--                                    </div>--}}
{{--                                    <div class="post-thumbnail">--}}
{{--                                        <a href="post-details.html">--}}
...
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <h4 class="title"><a href="post-details.html">Total monthly search--}}
{{--                                                traffic for API.</a></h4>--}}
{{--                                    </div>--}}
{{--                                    <div class="post-thumbnail">--}}
{{--                                        <a href="post-details.html">--}}
...
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <h4 class="title"><a href="post-details.html">Search improvements in Content--}}
{{--                                                Explorer</a></h4>--}}
{{--                                    </div>--}}
{{--                                    <div class="post-thumbnail">--}}
{{--                                        <a href="post-details.html">--}}
...
{{--                           aria-controls="grid-one" aria-selected="true">Keyword Research</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" role="presentation">--}}
{{--                        <a class="nav-link" id="grid-two" data-bs-toggle="tab" href="#gridtwo" role="tab"--}}
{{--                           aria-controls="grid-two" aria-selected="false">Link Building</a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item" role="presentation">--}}
{{--                        <a class="nav-link" id="grid-three" data-bs-toggle="tab" href="#gridthree" role="tab"--}}
{{--                           aria-controls="grid-three" aria-selected="false">Website Traffic</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--                <!-- Start Tab Content  -->--}}
...
{{--                                            <div class="post-thumbnail">--}}
{{--                                                <a href="post-details.html">--}}
{{--                                                    <img src="assets/images/post-images/post-grid-10.jpg"--}}
{{--                                                         alt="Post Images">--}}
{{--                                                </a>--}}
{{--                                            </div>--}}
{{--                                            <div class="post-grid-content">--}}
...
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <h4 class="title"><a href="post-details.html">How to create white--}}
{{--                                                            papers that convert</a></h4>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <!-- Start Post Grid  -->--}}
...
{{--                                            <div class="post-thumbnail">--}}
{{--                                                <a href="post-details.html">--}}
{{--                                                    <img src="assets/images/post-images/post-grid-11.jpg"--}}
{{--                                                         alt="Post Images">--}}
{{--                                                </a>--}}
{{--                                            </div>--}}
{{--                                            <div class="post-grid-content">--}}
...
{{--                                                            <a class="hover-flip-item-wrapper" href="#">--}}
{{--                                                                        <span class="hover-flip-item">--}}
{{--                                                                            <span data-text="DIGITAL MARKETING">DIGITAL MARKETING</span>--}}
{{--                                                                        </span>--}}
{{--                                                            </a>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <h4 class="title"><a href="post-details.html">Building agility with--}}
{{--                                                            technology and talent</a></h4>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <!-- Start Post Grid  -->--}}
...
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                            <h3 class="title"><a href="post-details.html">A five-step framework for--}}
{{--                                                    effective keyword targeting</a></h3>--}}
{{--                                            <div class="post-meta-wrapper">--}}
{{--                                                <div class="post-meta">--}}
{{--                                                    <div class="post-author-avatar border-rounded">--}}
{{--                                                        <img src="assets/images/post-images/author/author-image-2.png"--}}
...
{{--                                                                        <span class="hover-flip-item">--}}
{{--                                                                            <span--}}
{{--                                                                                data-text="Arlene McCoy">Arlene McCoy</span>--}}
{{--                                                                        </span>--}}
{{--                                                            </a>--}}
{{--                                                        </h6>--}}
{{--                                                        <ul class="post-meta-list">--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">Competitive Advantage in a Commoditized--}}
{{--                                Industry</a></h4>--}}
{{--                        <div class="post-meta-wrapper">--}}
{{--                            <div class="post-meta">--}}
{{--                                <div class="content">--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">How to Create a Useful and Well Optimized FAQ--}}
{{--                                Page</a></h4>--}}
{{--                        <div class="post-meta-wrapper">--}}
{{--                            <div class="post-meta">--}}
{{--                                <div class="content">--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">3 Digital PR Tenets for Excellent Outreach</a>--}}
{{--                        </h4>--}}
{{--                        <div class="post-meta-wrapper">--}}
{{--                            <div class="post-meta">--}}
{{--                                <div class="content">--}}
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <h4 class="title"><a href="post-details.html">Overcoming Blockers: How to Build Your Red Tape--}}
{{--                                Toolkit </a></h4>--}}
{{--                        <div class="post-meta-wrapper">--}}
{{--                            <div class="post-meta">--}}
{{--                                <div class="content">--}}
...
{{--                        <li class="instagram"><a href="#"><i class="fab fa-instagram"></i><span>Instagram</span></a>--}}
{{--                        </li>--}}
{{--                        <li class="youtube"><a href="#"><i class="fab fa-youtube"></i><span>Youtube</span></a></li>--}}
{{--                        <li class="pinterest"><a href="#"><i class="fab fa-pinterest"></i><span>Pinterest</span></a>--}}
{{--                        </li>--}}
