...
<div id="main-wrapper">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="message-center ps ps--theme_default"
                                         data-ps-id="d6e7cd39-1382-2282-72bb-a2bc556a7c75">
                                        <!-- Message -->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu mailbox dropdown-menu-end animated bounceInDown" aria-labelledby="2">
                            <ul>
                                ...
                                <li>
                                    <div class="message-center ps ps--theme_default"
                                         data-ps-id="d548ea6c-df57-db2c-191f-f89f1fdd414f">
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
    ...
    <aside class="left-sidebar">
        <!-- Sidebar scroll-->
        <div class="scroll-sidebar ps ps--theme_default ps--active-y" data-ps-id="9d82f20f-f2b6-0ab4-1707-77b6fda7765f">
            <!-- User Profile-->
            ...
            <nav class="sidebar-nav active">
                <ul id="sidebarnav" class="in">
                    ...
                    <li class="active">
                        <a class="has-arrow waves-effect waves-dark active" href="javascript:void(0)"
                           aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse in">
                            ...
                            <li class="active">
                                <a href="table-bootstrap.html" class="active">Bootstrap Tables</a>
                            </li>
                            <li>
            ...
            <div class="ps__scrollbar-y-rail" style="top: 0px; height: 472px; right: 0px;">
